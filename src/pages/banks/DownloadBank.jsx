...
const DownloadBank = ({ bank, invoices = [], summary = {} }) => {
    ...
    const {
        account_name, account_number, bank_name, account_currency,
            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.headerContainer}>
                    <View style={styles.headerLeft}>
                        <View style={styles.metaRow}>
                            ...
                            <Text style={styles.metaValue}>{account_name || 'N/A'}</Text>
                        </View>
                        <View style={styles.metaRow}>
                            <Text style={styles.metaLabel}>Account Number:</Text>
                            <Text style={styles.metaValue}>{account_number || 'N/A'}</Text>
                        </View>
                        <View style={styles.metaRow}>
                            <Text style={styles.metaLabel}>Bank Name:</Text>
                            <Text style={styles.metaValue}>{bank_name || 'N/A'}</Text>
                        </View>
                        <View style={styles.metaRow}>
                            <Text style={styles.metaLabel}>Account Currency:</Text>
                            <Text style={styles.metaValue}>{account_currency || 'N/A'}</Text>
                        </View>
                        <View style={styles.metaRow}>
                    ...
                    <View style={styles.headerRight}>
                        <Text style={styles.invoiceTypeText}>BANK ACCOUNT #</Text>
                        <Text style={styles.invoiceId}>{account_number || 'N/A'}</Text>
                    </View>
                </View>
                ...
                {invoices.length > 0 ? (
                    ...
                    <View style={styles.emptyState}>
                        <Text style={styles.emptyStateText}>No invoices have been generated for this bank account yet.</Text>
                    </View>
                )}
