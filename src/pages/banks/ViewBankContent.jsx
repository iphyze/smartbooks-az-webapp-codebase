...
import DownloadBank from "./DownloadBank"; // Updated Import
...
const ViewBankContent = ({ bank, invoices, summary }) => {
  ...
  const handleEditBank = () => {
    navigate(`/banks/edit/${bank.id}`, { state: { bank } });
  };
  ...
  return (
    ...
    >
      ...
      <div className="vc-button-box">
        <button className="vc-edit-btn" onClick={handleEditBank}>
          <span className="fas fa-pen"></span> Edit Bank Account
        </button>
        <PDFDownloadLink
          document={<DownloadBank bank={bank} invoices={invoices} summary={summary}/>} 
      ...
      <div className="vc-header-flexbox">
        <div className="vc-header-col">
          <div className="vc-header-group">
            <div className="vc-header-title">Account Name:</div>
            <div className="vc-header-text">{bank.account_name || 'N/A'}</div>
          </div>
          <div className="vc-header-group">
            <div className="vc-header-title">Account Number:</div>
            <div className="vc-header-text">{bank.account_number || 'N/A'}</div>
          </div>
          <div className="vc-header-group">
            <div className="vc-header-title">Bank Name:</div>
            <div className="vc-header-text">{bank.bank_name || 'N/A'}</div>
          </div>
          <div className="vc-header-group">
            <div className="vc-header-title">Account Currency:</div>
            <div className="vc-header-text">{bank.account_currency || 'N/A'}</div>
          </div>
          <div className="vc-header-group">
            <div className="vc-header-title">Created By:</div>
            <div className="vc-header-text">{bank.created_by || 'N/A'}</div>
          </div>
          <div className="vc-header-group">
            <div className="vc-header-title">Created On:</div>
            <div className="vc-header-text">{formatDateLong(bank.created_at)}</div>
          </div>
          <div className="vc-header-group">
            <div className="vc-header-title">Updated By:</div>
            <div className="vc-header-text">{bank.updated_by || 'N/A'}</div>
          </div>
          <div className="vc-header-group">
            <div className="vc-header-title">Updated On:</div>
            <div className="vc-header-text">{formatDateLong(bank.updated_at)}</div>
          </div>
        </div>

        <div className="vc-header-col vc-header-col-two">
          <div className="vc-voucher-type vc-inv-type">BANK ACCOUNT #</div>
          <div className="vc-voucher-type-number vc-inv-type-number">{bank.account_number || 'N/A'}</div>
        </div>
      </div>
      ...
      {invoices.length > 0 ? (
        ...
        <div className="vc-no-invoices-message">
          No invoices have been generated for this bank account yet.
        </div>
      )}
