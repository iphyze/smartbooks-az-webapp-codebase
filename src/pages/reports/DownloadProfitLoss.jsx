...
const S = StyleSheet.create({
  page:           { fontFamily: 'Montserrat-Regular', fontSize: 8, paddingTop: 66, paddingBottom: 40, paddingHorizontal: 26, backgroundColor: '#ffffff' },
  ...
  sectionLabel:   { fontFamily: 'Montserrat-Medium', fontSize: 7, color: TEXT3, textTransform: 'uppercase', letterSpacing: 0.6, marginBottom: 7 },
  summaryRow:     { flexDirection: 'row' },
  summaryCard:    { flex: 1, borderRadius: 4, paddingVertical: 9, paddingHorizontal: 10, borderWidth: 0.5 },
  summaryLabel:   { fontFamily: 'Montserrat-Medium', fontSize: 6.5, textTransform: 'uppercase', letterSpacing: 0.4, marginBottom: 4 },
  summaryValue:   { fontFamily: 'Montserrat-Bold', fontSize: 11, color: TEXT1, marginBottom: 2 },
  summaryCur:     { fontFamily: 'Montserrat-Medium', fontSize: 6.5 },
  ...
  catName:        { fontFamily: 'Montserrat-Bold', fontSize: 8.5, marginRight: 8 },
  catCount:       { fontFamily: 'Montserrat-Light', fontSize: 6.5, color: TEXT3 },
  catTotalVal:    { fontFamily: 'Montserrat-Bold', fontSize: 10 },
  ...
  subTd:          { fontFamily: 'Montserrat-Bold', fontSize: 8, color: TEXT1, paddingVertical: 6, paddingHorizontal: 6, borderRightWidth: 0.5, borderRightColor: BORDER },
  ...
  milestoneLabel: { fontFamily: 'Montserrat-Bold', fontSize: 8, textTransform: 'uppercase', letterSpacing: 0.5 },
  milestoneVal:   { fontFamily: 'Montserrat-Bold', fontSize: 11 },
