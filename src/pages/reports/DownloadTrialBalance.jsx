...
const S = StyleSheet.create({
  page:           { fontFamily: 'Montserrat-Regular', fontSize: 7.7, paddingTop: 68, paddingBottom: 42, paddingHorizontal: 28, backgroundColor: '#ffffff' },
  ...
  sectionLabel:   { fontFamily: 'Montserrat-Medium', fontSize: 6.3, color: TEXT3, textTransform: 'uppercase', letterSpacing: 0.6, marginBottom: 8 },
  ...
  summaryLabel:   { fontFamily: 'Montserrat-Medium', fontSize: 6.3, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 5 },
  summaryValue:   { fontFamily: 'Montserrat-Bold', fontSize: 11.7, color: TEXT1, marginBottom: 2 },
  summaryCur:     { fontFamily: 'Montserrat-Medium', fontSize: 6.3 },
  ...
  className:      { fontFamily: 'Montserrat-Bold', fontSize: 8.1 },
  classCount:     { fontFamily: 'Montserrat-Light', fontSize: 6.3, color: TEXT3, marginTop: 1 },
  ...
  classSubLabel:  { fontFamily: 'Montserrat-Medium', fontSize: 5.9, textTransform: 'uppercase', letterSpacing: 0.4, marginBottom: 2 },
  classSubVal:    { fontFamily: 'Montserrat-Bold', fontSize: 8.1 },
  tableHeader:    { flexDirection: 'row' },
  th:             { fontFamily: 'Montserrat-SemiBold', fontSize: 6.3, color: '#ffffff', paddingVertical: 6, paddingHorizontal: 7, textTransform: 'uppercase', letterSpacing: 0.3, borderRightWidth: 0.5, borderRightColor: 'rgba(255,255,255,0.25)' },
  ...
  td:             { fontFamily: 'Montserrat-Light', fontSize: 7.2, color: TEXT2, paddingVertical: 5, paddingHorizontal: 7, borderRightWidth: 0.5, borderRightColor: BORDER },
  subtotalRow:    { flexDirection: 'row', backgroundColor: GRAY, borderTopWidth: 1.5 },
  subTd:          { fontFamily: 'Montserrat-Bold', fontSize: 7.2, color: TEXT1, paddingVertical: 7, paddingHorizontal: 7, borderRightWidth: 0.5, borderRightColor: BORDER },
  grandTotalRow:  { flexDirection: 'row', backgroundColor: 'rgba(0,177,150,0.06)', borderTopWidth: 2, borderTopColor: BRAND, marginTop: 6 },
  grandTd:        { fontFamily: 'Montserrat-Bold', fontSize: 8.1, color: TEXT1, paddingVertical: 9, paddingHorizontal: 7, borderRightWidth: 0.5, borderRightColor: BORDER },
