...
const S = StyleSheet.create({
  page: { fontFamily: 'Montserrat-Regular', fontSize: 7.4, paddingTop: 68, paddingBottom: 40, paddingHorizontal: 22, backgroundColor: '#ffffff' },
  ...
  reportMeta: { fontFamily: 'Montserrat-Medium', fontSize: 7, color: TEXT2, marginTop: 2 },
  ...
  groupText: { fontFamily: 'Montserrat-Bold', fontSize: 7.2, color: BRAND, paddingVertical: 5.5, paddingHorizontal: 5, borderRightWidth: 0.5, borderRightColor: BORDER },
  ...
  groupTotal: { fontFamily: 'Montserrat-Bold', fontSize: 7.2, color: TEXT1, paddingVertical: 5.5, paddingHorizontal: 5, textAlign: 'right' },
  tableRow: { flexDirection: 'row', borderBottomWidth: 0.5, borderBottomColor: BORDER },
  rowEven: { backgroundColor: '#ffffff' },
  rowOdd: { backgroundColor: GRAY },
  td: { fontFamily: 'Montserrat-Light', fontSize: 6.9, color: TEXT2, paddingVertical: 5, paddingHorizontal: 5, borderRightWidth: 0.5, borderRightColor: BORDER },
  totalsRow: { flexDirection: 'row', backgroundColor: 'rgba(0,177,150,0.08)', borderTopWidth: 2, borderTopColor: BRAND },
  totalsTd: { fontFamily: 'Montserrat-Bold', fontSize: 7, color: TEXT1, paddingVertical: 6.5, paddingHorizontal: 5, borderRightWidth: 0.5, borderRightColor: BORDER },
