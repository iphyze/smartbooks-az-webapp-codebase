...
const S = StyleSheet.create({
  page:           { fontFamily: 'Montserrat-Regular', fontSize: 8, paddingTop: 64, paddingBottom: 40, paddingHorizontal: 24, backgroundColor: '#ffffff' },
  ...
  sectionHeadingText: { fontFamily: 'Montserrat-Bold', fontSize: 9, color: '#ffffff', textTransform: 'uppercase', letterSpacing: 0.6 },
  ...
  subHeadingText: { fontFamily: 'Montserrat-SemiBold', fontSize: 7.5, color: BRAND, textTransform: 'uppercase', letterSpacing: 0.5 },
  ...
  treasuryText:   { fontFamily: 'Montserrat-Medium', fontSize: 7, color: TEXT3, textTransform: 'uppercase', letterSpacing: 0.4 },
  ...
  summaryLabel:    { fontFamily: 'Montserrat-Bold', fontSize: 7.5, color: BRAND, textTransform: 'uppercase', letterSpacing: 0.4 },
  summaryLabelGrand:{ fontFamily: 'Montserrat-Bold', fontSize: 8.5, color: BRAND },
  summaryVal:      { fontFamily: 'Montserrat-Bold', fontSize: 9, color: TEXT1 },
  summaryValGrand: { fontFamily: 'Montserrat-Bold', fontSize: 11, color: TEXT1 },
  ...
  catTitleText:    { fontFamily: 'Montserrat-SemiBold', fontSize: 8, color: TEXT1 },
  catTitleLessText:{ fontFamily: 'Montserrat-Light', fontSize: 7.5, color: TEXT3 },

  tableHeader:     { flexDirection: 'row', backgroundColor: BRAND2 },
  th:              { fontFamily: 'Montserrat-SemiBold', fontSize: 6.5, color: '#ffffff', paddingVertical: 5, paddingHorizontal: 6, textTransform: 'uppercase', letterSpacing: 0.3, borderRightWidth: 0.5, borderRightColor: 'rgba(255,255,255,0.25)' },
  tableRow:        { flexDirection: 'row', borderBottomWidth: 0.5, borderBottomColor: BORDER },
  rowEven:         { backgroundColor: '#ffffff' },
  rowOdd:          { backgroundColor: GRAY },
  td:              { fontFamily: 'Montserrat-Light', fontSize: 7.5, color: TEXT2, paddingVertical: 5, paddingHorizontal: 6, borderRightWidth: 0.5, borderRightColor: BORDER },
  subtotalRow:     { flexDirection: 'row', backgroundColor: 'rgba(0,177,150,0.05)', borderTopWidth: 1.5, borderTopColor: BRAND },
  subTd:           { fontFamily: 'Montserrat-Bold', fontSize: 7.5, color: TEXT1, paddingVertical: 6, paddingHorizontal: 6, borderRightWidth: 0.5, borderRightColor: BORDER },
  ...
  cyeLabel:        { fontFamily: 'Montserrat-SemiBold', fontSize: 8, color: TEXT2 },
  cyeVal:          { fontFamily: 'Montserrat-Bold', fontSize: 9, color: TEXT1 },
