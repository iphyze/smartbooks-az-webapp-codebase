        ...
        <div className="tsr-filter-field">
          ...
          <div className="form-wrapper">
            <Select
              ...
              onInputChange={(v) => searchStaff(v.length > 1 ? v : '')}
...
const ResultsView = ({ data, summary, meta, pagination, onExcel, excelLoading, onPageChange, loading }) => {
  const pdfDocument = useMemo(() => (
    <DownloadTimesheetReport data={data || []} summary={summary} meta={meta || {}} />
  ), [data, summary, meta]);
    ...
    <motion.div variants={fadeUp} initial="hidden" animate="show">
      <div className="tsr-action-bar">
        ...
        <div className="tsr-action-right">
          ...
          <PDFDownloadLink document={pdfDocument} fileName={`Timesheet_Report_${meta?.datefrom || 'from'}_to_${meta?.dateto || 'to'}_Page_${pagination?.page || 1}.pdf`}>
            {({ loading: pdfLoading }) => (
              <button className="tsr-pdf-btn" disabled={pdfLoading}>
...
const TimesheetReport = () => {
  ...
  const { timesheetReport, fetchPaginatedTimesheetReport, downloadTimesheetExcel } = useTimesheetReportStore();
