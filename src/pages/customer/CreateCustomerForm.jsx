...
const CreateCustomerForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      ...
      // navigate("/customers"); // In a real app, this would navigate to customers page
    }, 1500);
  };
            ...
            <div className="invoice-action-btn">
                <div className="invoice-action-btn-wrapper">
                    ...
                    <button type="submit" disabled={isLoading} className="invoice-submit-btn">
                        {isLoading ? <div className="invoice-loader"></div> : <span className="invoice-submit-btn-text">Submit Invoice</span>}
                    </button>
                </div>
            </div>
          </form>
