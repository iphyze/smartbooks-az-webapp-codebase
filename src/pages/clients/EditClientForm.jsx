...
/* ─────────────────────────────────────────────
   Main Component
───────────────────────────────────────────── */
const EditClientForm = ({ clientId, client, onSaveSuccess }) => {
  ...
  /* ── Populate form when client prop arrives ── */
  useEffect(() => {
    if (!client) return;
    ...
    setClientDetails({
      ...
      clients_number: client.clients_number || "",
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      clients_id: clientDetails.clients_id,
    ...
    const success = await editClient(payload);
    ...
    >
      ...
      >
        ...
        <div className="invoice-form-header">
          <div className="invoice-form-htxt">Edit Client</div>
          <div className="invoice-form-sub-htxt">
            Update the details below to edit Client ID #{clientDetails.clients_id || clientId}
          </div>
        </div>
              ...
              <div className="input-form-group input-disabled">
                ...
                <div className="form-wrapper">
                  <input
                    ...
                    value={clientDetails.clients_id || "---"}
                    disabled
                    readOnly
                  />
                </div>
          ...
          <div className="invoice-action-btn-wrapper">
            ...
            >
              {isLoading ? (
                ...
                <span className="invoice-submit-btn-text">Update Client</span>
              )}
            </button>
          </div>
        </div>
