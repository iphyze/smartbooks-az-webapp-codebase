...
const SupplierSchedule = () => {
  ...
  const {
    ...
    getTotalPages, exportToExcel, clearSelection, getCurrentPageData, getFilteredData, loading
  ...
  return(
    ...
    <div className={`main-container theme-${theme}`}>
      ...
      <div className={`content-container theme-${theme}`}>
        ...
        <div className="data-table-title">Gaps Payment Schedule</div>
        ...
        <div className="data-table-date-picker-container">
        ...
        <select disabled={selectedItems.length === 0} onChange={(e) => {handleActionSelect(e.target.value); e.target.value = ''}}
            className={`global-action-select ${selectedItems.length === 0 ? 'disabled' : ''}`} value="">
        ...
        <div className="filters-page-show-text">Entries for</div>

        <div className="action-section">
            <select value={selectedYear} onChange={handleYearChange} className="items-per-page-select itp-sm">
    ...
    {/* <div className={`modal-box ${showViewModal && 'show-modal'}`}>
