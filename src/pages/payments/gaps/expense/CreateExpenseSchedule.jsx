...
// Add this function after the resetForm function (around line 150):
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.post('/gaps/expense/expenseGaps', rowsWithDate, {
        headers: { Authorization: `Bearer ${token}` }
      });
      
      resetForm();
      showToast(response?.data?.message, 'success');
      navigate("/payments/gaps/expense");
      ...
      <div className={`content-container theme-${theme}`}>
        <div className="content-container-h-flexbox" data-aos='fade-down'>
          ...
          <div className="cch-title-box">
            ...
            <NavLink to='/payments/gaps/expense' className="ccht-titlelink">Expense</NavLink>
            <span className="ccht-arrow fas fa-chevron-right"></span>
        ...
        <table className="gaps-table">
          <thead>
            <tr>
              ...
              <th className="gaps-desc-th">Description</th>
...
export default CreateExpenseSchedule;