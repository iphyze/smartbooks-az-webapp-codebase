...
import useExpenseGapsStore from "../../../../stores/useExpenseGapsStore";
...
const handleBatchChange = (e) => {
  ...
  useExpenseGapsStore.setState({ batch });
  fetchData();
};
      ...
      <div className={`content-container theme-${theme}`}>
        <div className="content-container-h-flexbox" data-aos='fade-down'>
          <div className="cch-flexbox">
            <p className="content-header">Gaps Expense</p>
          </div>
          <div className="cch-title-box">
            ...
            <span className="ccht-arrow fas fa-chevron-right"></span>
            <p className="ccht-titletext">Expense</p>
          </div>
        </div>
           ...
           {loading ? (
                ...
                <table className="datatable-table">
                    ...
                    <tr>
                        ...
                        <th onClick={() => handleSort('remark')} className="sortable-header">
                            Remark
                            <span className="sort-icon">
                            {sortBy === 'remark' ? (
                                <i className={`fas fa-sort-${sortOrder === 'asc' ? 'up' : 'down'}`} />
                    ...
                    {currentItems.map((item, index) => (
                        ...
                        <td title={truncateWithTooltip(item.remark).tooltipText}>
                            {truncateWithTooltip(item.remark).displayText}
                        </td>
                        <td>
