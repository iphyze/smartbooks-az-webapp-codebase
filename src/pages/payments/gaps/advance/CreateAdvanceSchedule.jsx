...
const CreateAdvanceSchedule = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(rowsWithDate);

      const response = await api.post('/gaps/advance/suppliersAdvanceGaps', rowsWithDate, {
        headers: { Authorization: `Bearer ${token}` }
      });

      resetForm();
      showToast(response?.data?.message, 'success');
      navigate("/payments/gaps/advance");
              ...
              <tbody>
                {rows.map((row, index) => (
                  <tr key={index}>
                    ...
                    <td className="gaps-suppliers-td">
                      <AsyncSelect
                        isClearable
...
export default CreateAdvanceSchedule;