...
const FxPayments = () => {
  ...
  useEffect(() => {
      ...
      document.title = "Acctlab | FX Payments";
    ...
    <div className={`content-container theme-${theme}`}>
      <div className="content-container-h-flexbox" data-aos='fade-down'>
        <div className="cch-flexbox">
          ...
          <p className="content-header">FX Payments</p>
        </div>
        <div className="cch-title-box">
          <NavLink to='/' className="ccht-titlelink">FX Payments</NavLink>
