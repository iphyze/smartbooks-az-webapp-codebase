...
import EditCompassModal from "./EditCompassModal";
import useCompassRequestStore from "../../../../stores/fund-request/useCompassRequestStore";
import UpdateModal from "../../../../components/UpdateModal";
import PrepareCompassGapsModal from "./PrepareCompassGapsModal";
...
const handleYearChange = (e) => {
  ...
  if (e.target.checked) {
    ...
    useCompassRequestStore.setState({ 
  ...
  useEffect(() => {
    ...
    document.title = "Acctlab | Compass Fund Request";
    fetchData();
      ...
      <div className={`content-container theme-${theme}`}>
        <div className="content-container-h-flexbox" data-aos='fade-down'>
          ...
          <div className="cch-title-box">
            ...
            <span className="ccht-arrow fas fa-chevron-right"></span>
            <p className="ccht-titletext">Compass</p>
          </div>
        </div>
        ...
        <div className="data-table-title">Compass</div>
                  ...
                  {currentItems.map((item, index) => (
                    <tr key={item.id}>
                      ...
                      <td title={truncateWithTooltip(item.invoice_number).tooltipText}>
                        <b>Inv. No.:</b> {truncateWithTooltip(item.invoice_number).displayText} <br /><br />
                        <b>Desc</b><br /> {truncateWithTooltip(item.description).displayText}
                      </td>
