      ...
      <div className="view-modal" onClick={handleModalClick}>
        ...
        <div className='view-modal-content'>
            ...
            <div className='view-modal-details'>
                <div className='vmc-ht'>Supplier's / Invoice Details</div>
                ...
                <div className='view-info-flexbox'>
                    ...
                    <div className='view-info-col'>
                        <div className='view-info-ht'>Invoice No.</div>
                        <div className='view-info-text'>{viewData?.invoice_number}</div>
                    </div>
                </div>

                <div className='view-info-flexbox'>
                    <div className='view-info-col'>
                        <div className='view-info-ht'>Invoice Date</div>
                        <div className='view-info-text'>{viewData?.invoice_date}</div>
                    </div>
                </div>
            ...
            <div className='view-modal-details'>
                <div className='vmc-ht'>Purchase/Po Details</div>

                <div className='view-info-flexbox'>
                    <div className='view-info-col'>
                        <div className='view-info-ht'>Purchase Number</div>
                        <div className='view-info-text'>{viewData?.purchase_number}</div>
                    </div>
                    <div className='view-info-col'>
                ...
                <div className='view-info-flexbox'>
                    <div className='view-info-col'>
                        <div className='view-info-ht'>Purchase Date</div>
                        <div className='view-info-text'>{viewData?.purchase_date}</div>
                    </div>
                    <div className='view-info-col'>
                        <div className='view-info-ht'>Project Code</div>
                        <div className='view-info-text'>{viewData?.project_code}</div>
                    </div>
                </div>
                ...
                <div className='view-info-flexbox'>
                    ...
                    <div className='view-info-col'>
                        <div className='view-info-ht'>Decription</div>
                        <div className='view-info-text'>{viewData?.description}</div>
                    </div>
                </div>
            </div>
            ...
            <div className='view-modal-details'>
                ...
                <div className='view-info-flexbox'>
                    <div className='view-info-col'>
                        <div className='view-info-ht'>Vat Policy</div>
                        <div className='view-info-text view-info-digit'>{viewData?.vat_policy}</div>
                    </div>
                    <div className='view-info-col'>
                        <div className='view-info-ht'>Net Value</div>
                        <div className='view-info-text view-info-digit'>₦ {formatAmount(viewData?.net_value)}</div>
                    </div>
                </div>
                ...
                <div className='view-info-flexbox'>
                    ...
                    <div className='view-info-col'>
                        <div className='view-info-ht'>WHT</div>
                        <div className='view-info-text view-info-digit'>₦ {formatAmount(viewData?.wht)}</div>
                    </div>
                ...
                <div className='view-info-flexbox'>
                    <div className='view-info-col'>
                        <div className='view-info-ht'>Total</div>
