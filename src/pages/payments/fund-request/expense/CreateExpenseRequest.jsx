...
const CreateExpenseRequest = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.post('/request/expense/create', payload, {
  ...
  const handleCancel = () => {
    setFormData({
      ...
      setSupplierSelection(null);
      setProjectSelection(null);
      navigate("/payments/fund-request/expense");
  }
      ...
      <div className={`content-container theme-${theme}`}>
        <div className="content-container-h-flexbox" data-aos='fade-down'>
          ...
          <div className="cch-title-box">
            ...
            <NavLink to='/payments/fund-request/expense' className="ccht-titlelink">Expense</NavLink>
            <span className="ccht-arrow fas fa-chevron-right"></span>
