...
import useExpenseRequestStore from "../../../../stores/fund-request/useExpenseRequestStore";
import UpdateModal from "../../../../components/UpdateModal";
import PrepareExpenseGapsModal from "./PrepareExpenseGapsModal";
...
const handleYearChange = (e) => {
  ...
  if (e.target.checked) {
    ...
    useExpenseRequestStore.setState({ 
  ...
  useEffect(() => {
    ...
    document.title = "Acctlab | Expense Fund Request";
    fetchData();
      ...
      <div className={`content-container theme-${theme}`}>
        <div className="content-container-h-flexbox" data-aos='fade-down'>
          ...
          <div className="cch-title-box">
            ...
            <span className="ccht-arrow fas fa-chevron-right"></span>
            <p className="ccht-titletext">Epxense</p>
          </div>
        </div>
        ...
        <div className="data-table-title">Expense</div>
                  ...
                  {currentItems.map((item, index) => (
                    <tr key={item.id}>
                      ...
                      <td title={truncateWithTooltip(item.invoice_number).tooltipText}>
                        <b>Inv. No.:</b> {item.invoice_number} <br /><br />
                        <b>Desc</b><br /> {truncateWithTooltip(item.description).tooltipText}
                      </td>
