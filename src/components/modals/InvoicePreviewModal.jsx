...
const InvoicePreviewModal = ({ isOpen, onClose, invoiceDetails, invoiceItems, totals, selectedCustomer }) => {
            ...
            <div className="invoice-details-body">
               ...
               <div className="invoice-details">
                <div className="invoice-det-cols">
                    ...
                    <span className="value thick-value">INV-{Date.now()}</span>
                </div>
                <div className="invoice-det-cols">
                    <span className="label">Date Issued:</span>
                    <span className="value">{formatDate(invoiceDetails.invoiceDate)}</span>
                </div>
                <div className="invoice-det-cols">
                    <span className="label">Due Date:</span>
                    <span className="value">{formatDate(invoiceDetails.dueDate)}</span>
                </div>
                </div>
              ...
              <div className="customer-info">
                ...
                <p className="customer-info-text">{invoiceDetails.customerName}</p>
              </div>
                  ...
                  <table className="invoice-details-table">
                    ...
                    <tbody>
                      {invoiceItems.map((item, index) => {
                        ...
                        const afterDiscount = itemTotal - item.discountAmount;
                        const lineTotal = afterDiscount + (afterDiscount * (item.vatPercent / 100));
                        ...
                        return (
                          <tr key={index}>
                            ...
                            <td>{formatWithDecimals(item.discountAmount)}</td>
              ...
              <div className="invoice-details-summary">
                ...
                <div className="summary-row total">
                  ...
                  <span className="details-summary-amount">{formatWithDecimals(totals.grandTotal)}</span>
                </div>
              </div>
            </div>
